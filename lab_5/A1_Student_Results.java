...
class A1_Student_Results {
    public static void main(String args[]) {
        ...
        System.out.print("Enter student 1 marks as m1 m2 m3: ");
        r.storeStudentMarks(sc.nextInt(), sc.nextInt(), sc.nextInt());

        System.out.print("Enter student 2 marks as m1 m2 m3: ");
        r.storeStudentMarks(sc.nextInt(), sc.nextInt(), sc.nextInt());

        System.out.print("Enter student 3 marks as m1 m2 m3: ");
        r.storeStudentMarks(sc.nextInt(), sc.nextInt(), sc.nextInt());
        sc.close();
